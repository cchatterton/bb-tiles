...
.s-texttile{background:#fcb452;padding:30px;-moz-box-sizing: border-box;-webkit-box-sizing: border-box;box-sizing: border-box;}
...
.s-texttile p{margin-top:20px; color:white; text-shadow: rgba(0,0,0,0.1) 0px 1px 1px; line-height:2;}
...
.s-texttile a:hover {background: rgba(255,255,255,0.6);color: rgba(0,0,0,0.5);border: 1px solid rgba(0,0,0,0.3);}
*/
