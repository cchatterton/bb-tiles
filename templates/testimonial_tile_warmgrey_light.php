...
Tile: Testimonial Tile - Warm Grey (Light)
Version: 1.0
...
// CSS
/*
div{background:#D8D1C9;padding:30px;-moz-box-sizing: border-box;-webkit-box-sizing: border-box;box-sizing: border-box;}
p,sub{margin-top:20px; color:#706258 !important; text-shadow: rgba(0,0,0,0.1) 0px 1px 1px;}
sub {font-weight:400; font-style:normal !important;}
*/
