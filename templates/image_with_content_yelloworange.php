...
Tile: Image Tile with Content - YELLOW ORANGE
Version: 1.12
...
.arrow-up {width: 0; height: 0; position: relative; margin-top: -19px; margin-left: 20px; border-left: 20px solid transparent;  border-right: 20px solid transparent; border-bottom: 20px solid #FFB546;}
.tile-content {background-color: #FFB546; padding: 10px 30px; white-space: pre-line;}
.content-with-img {background-color: #FFB546;}
*/
