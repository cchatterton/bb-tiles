...
Tile: Image Tile with Content - WHEAT 
Version: 1.12
Variation: 1.03 for nwcc
Author: BROWN BOX
...
.arrow-up {width: 0; height: 0; position: relative; margin-top: -19px; margin-left: 20px; border-left: 20px solid transparent;  border-right: 20px solid transparent; border-bottom: 20px solid #F3DAB1;}
.tile-content {background-color: #F3DAB1; padding: 10px 30px; white-space: pre-line;}
.content-with-img {background-color: #F3DAB1;}
