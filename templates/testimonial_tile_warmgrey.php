...
Tile: Testimonial Tile - Warm Grey (Dark)
Version: 1.0
...
// CSS
/*
div{background:#706258;padding:30px;-moz-box-sizing: border-box;-webkit-box-sizing: border-box;box-sizing: border-box;}
p,sub{margin-top:20px; color:white !important; text-shadow: rgba(0,0,0,0.1) 0px 1px 1px;}
