...
Tile: Image Tile with Content - PINE CONE
Version: 1.12
...
h1 {font-size: 24px; color: #FFFFFF; font-weight: 300;}
p {color: #FFFFFF; font-size: 14px;}
.arrow-up {width: 0; height: 0; position: relative; margin-top: -19px; margin-left: 20px; border-left: 20px solid transparent;  border-right: 20px solid transparent; border-bottom: 20px solid #706258;}
.tile-content {background-color: #706258; padding: 10px 30px; white-space: pre-line;}
.content-with-img {background-color: #706258;}
